        ...
        >
          {item.subMenu && item.subMenu.length > 0 ? (
            <div className="flex items-center space-x-5">
              ...
              <h1
                className={`text-white text-sm md:text-base font-medium cursor-pointer w-full ${
                  isOpen ? '' : 'hidden'
                }`}
              >
                {item.name}
          ...
          {item.subMenu && item.subMenu.length > 0 && isOpen && (
            <ChevronRight
              className={`duration-300 text-white text-sm md:text-base transition-transform ${
