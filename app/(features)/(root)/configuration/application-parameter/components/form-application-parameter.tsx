...
import useAddSystemSetting from "../hook/use-add-application-parameter"
import FormInput from "@/shared/components/form/form-input"
 

interface PropTypes {
    data?: TApplicationParameter;
    onClose?: () => void;
}

const FormApplicationParameter = (props:PropTypes) => {
...
export default FormApplicationParameter